...
\add_filter('update_plugins_github.com', function ($update, array $plugin_data, string $plugin_slug) {
...
*/
\add_filter('plugins_api', function ($result, string $action, \stdClass $args) {
